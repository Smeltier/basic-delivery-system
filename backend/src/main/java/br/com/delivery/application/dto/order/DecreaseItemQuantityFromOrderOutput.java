...
public record DecreaseItemQuantityFromOrderOutput(OrderId orderId, Money newTotal, List<OrderItemOutput> remainingItems) {
  public DecreaseItemQuantityFromOrderOutput {
